...
sections:
  ...
  - block: markdown-wide
    content:
      ...
      subtitle: 
      text: |
        <em style="font-size: 14px;">(Header Image: [Maracanã Stadium, Rio de Janeiro, Brazil](https://riotur.rio/en/que_fazer/maracanastadium/). Image by Bianca Tarrisse da Fontoura.)</em>
    design:
      columns: '1'
      spacing:
        # Customize the section spacing. Order is top, right, bottom, left.
